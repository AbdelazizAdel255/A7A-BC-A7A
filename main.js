...
// توكن البوت
var token = "NzI3NTI4Mzk4ODg4MzcwMTc2.XvtJnw.j6yo7yEXgLvczGPtGa-226ZFfWU";
// الاختصار المستخدم في الاوامر
const prefix = "#";
// نشاط البوت
var activity = "Future Clan BC";
// حالة البوت
var status = "online";
/**
		...
		if (message.content.startsWith(prefix))
		{
			...
			switch(command)
			{
				...
				case "bc":
					if(message.member.hasPermission(Discord.Permissions.ALL))
					{
						message.reply(' **Done** <a:563109790872764451:733020278581493871> ');
						...
						message.channel.send(" **Sent To** " + " **`` " + sentsuccess +  "/"  + (message.guild.memberCount - bots) + " ``** ");
					}
					else
					{
